...
async function fetchCountryData(countryName){
    ...
    //    console.log(data) 
       ...
       if(data.length === 1){
        ...
        console.log(error)
        messageElement.textContent = "No result found. Please check your spelling and try again. This tool is built to search for the names of countries in English only, sorry."
...
function displayCountryInfo(countryData, container){
    ...
    <p><strong>Capital:</strong>${countryData.capital ? 
    countryData.capital.join(", "): "Not available"} </p> 
